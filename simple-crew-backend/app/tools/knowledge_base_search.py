...
def get_search_knowledge_base_tool(kb_id: str, framework: str = 'crewai'):
    """
    Factory that returns a knowledge-base search tool compatible with the
    requested framework ('crewai' or 'langgraph').
    """
    ...
    if framework == 'langgraph':
        ...
        return tool("company_knowledge_search")(search_knowledge_base)
